...
const faqs = [
  {
    ...
    answer: "Most engagements kick off within a week once scope is agreed.",
  },
  {
    id: "tools",
    question: "What tools do you automate with?",
    answer: "We work across modern ops stacks, from CRMs to internal systems.",
  },
  {
    id: "handoff",
    question: "Will my team be able to run it?",
    answer: "Yes. You get clear handoff notes and support for adoption.",
  },
  {
    id: "security",
    question: "How do you handle access and security?",
    answer: "We use least-privilege access and document everything we touch.",
  },
  {
    id: "scope",
    question: "What if the process is complex?",
    answer: "We map it first, then automate in phases to reduce risk.",
  },
  {
    id: "results",
    question: "What kind of results should we expect?",
    answer: "Less manual work, fewer errors, and clearer operational flow.",
  },
];
