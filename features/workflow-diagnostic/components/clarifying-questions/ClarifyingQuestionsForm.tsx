...
import {
  type ClarifyingAnswersPayload,
  type ClarifyingQuestionsSchema,
} from "@/features/workflow-diagnostic/types/clarifying-schema";
import { isFieldVisible } from "@/features/workflow-diagnostic/lib/clarifying/dependency";
import {
  validateAnswers,
} from "@/features/workflow-diagnostic/lib/clarifying/validation";
import { QuestionFieldRenderer } from "@/features/workflow-diagnostic/components/clarifying-questions/QuestionFieldRenderer";
...
export function ClarifyingQuestionsForm({
  ...
  const answers = clarifyingAnswersByRound[schema.roundId] ?? {};
